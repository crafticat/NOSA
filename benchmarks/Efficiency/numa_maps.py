"""(Copied verbatim from fork commit ae8c454 benchmarks/Efficiency/numa_maps.py, branch feature/nosi-verify-alone-dev,
for the weights-versus-KV batch sweep; read-only reuse, the dev worktree is not touched.)
